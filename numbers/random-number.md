...
# How to Random Number in C#

## Description
This guide explains how to random number in C# with simple examples.
...
class Program
{
    ...
    {
        Console.WriteLine("Example for How to Random Number in C#");
    }
}
```
...
## Output
```
Example for How to Random Number in C#
```
...
## SEO Keywords
how to random number in c#, random number, c# how to, c# tutorial