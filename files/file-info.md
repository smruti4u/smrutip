...
# How to File Info in C#

## Description
This guide explains how to file info in C# with simple examples.
...
class Program
{
    ...
    {
        Console.WriteLine("Example for How to File Info in C#");
    }
}
```
...
## Output
```
Example for How to File Info in C#
```
...
## SEO Keywords
how to file info in c#, file info, c# how to, c# tutorial